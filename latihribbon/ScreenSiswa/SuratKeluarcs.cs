    ...
    public partial class SuratKeluarcs : Form
    {
        ...
        private void printDocumentKeluar_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                e.Graphics.DrawString($": {txtNama.Text}", Times8Bold, Brushes.Black, new Point(125, 40));
                ...
                e.Graphics.DrawString($": {jamKembali.Value.ToString("HH:mm")}", Times8Bold, Brushes.Black, new Point(125, 120));
                ...
                e.Graphics.DrawString($": {txtNama.Text}", Times8Bold, Brushes.Black, new Point(125, 250));
                ...
                e.Graphics.DrawString($": {jamKembali.Value.ToString("HH:mm")}", Times8Bold, Brushes.Black, new Point(125, 330));
                ...
                e.Graphics.DrawString($": {txtNama.Text}", Times8Bold, Brushes.Black, new Point(125, 440 + 15));
                ...
                e.Graphics.DrawString($": {jamKembali.Value.ToString("HH:mm")}", Times8Bold, Brushes.Black, new Point(125, 520 + 15));
                ...
                if (GetTextWidth(alasan, Times8Regular, e.Graphics) > batasPiksel)
                {
                    ...
                    e.Graphics.DrawString($": {baris1.Trim()}", Times8Bold, Brushes.Black, new Point(125, 350));
                    e.Graphics.DrawString($"{baris2.Trim()}", Times8Bold, Brushes.Black, new Point(125, 370));
                    e.Graphics.DrawString($"{baris3.Trim()}", Times8Bold, Brushes.Black, new Point(125, 390));

                    e.Graphics.DrawString($": {baris1.Trim()}", Times8Bold, Brushes.Black, new Point(125, 540 + 15));
                    e.Graphics.DrawString($"{baris2.Trim()}", Times8Bold, Brushes.Black, new Point(125, 560 + 15));
                    e.Graphics.DrawString($"{baris3.Trim()}", Times8Bold, Brushes.Black, new Point(125, 580 + 15));
                }
                else
                {
                    e.Graphics.DrawString($": {alasan}", Times8Bold, Brushes.Black, new Point(125, 140));
                    e.Graphics.DrawString($": {alasan}", Times8Bold, Brushes.Black, new Point(125, 350));
                    e.Graphics.DrawString($": {alasan}", Times8Bold, Brushes.Black, new Point(125, 540 + 15));
                }
            }
            catch (Exception ex)
            {
